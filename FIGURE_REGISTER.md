...
| main_experiment.py         | _validation_scenario_heatmap.png  | VALIDATION ONLY          | NOT a manuscript figure |
...
| E_sigmoid_calibration.py   | _validation_sigmoid_calibration.png | TABLE + VALIDATION     | anchors + robustness |
| D_self_organization.py     | _validation_self_organization.png | TABLE (Table 7)          | Phi_ord/Moran's I/H |
| F_sensitivity.py           | _validation_sensitivity.png       | TABLE (Table 8)          | Spearman rho |
| G_multilayer.py            | _validation_multilayer.png        | INLINE sentence          | result is "no effect"|
